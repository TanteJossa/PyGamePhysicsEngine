        ...
        if isVertical == True:
            ...
            for setting in settings[divisioncount]:
                ...
                create_text(str(setting[0]), maxcoords=((leftup[0] + 10 + reached_bottom * (rightdown[0] - leftup[0]) / 2, leftup[1] + totalSpace + nameSize - 20 + setting_row_count * 25 + reached_bottom * 25), 
                                                        (leftup[0] + (rightdown[0] - leftup[0]) / 2 + 10 + reached_bottom * (rightdown[0] - leftup[0]) / 4, leftup[1] + totalSpace + nameSize + 5 + setting_row_count * 25 + reached_bottom * 25)))
                

                valueBox = ((leftup[0] + 10 + reached_bottom * (rightdown[0] - leftup[0]) / 2 + (rightdown[0] - leftup[0] - 30) / 4, leftup[1] + totalSpace + nameSize - 20 + setting_row_count * 25 + reached_bottom * 25), 
...
#                print('Hello World!')
    ...
    create_menu((underMenuX1, underMenuY1), (underMenuX2, underMenuY2), isVertical=False, divisions=[1,2,1], names=["Grafiek", "Tijd", "Settings"])
